                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                       minimumSize: Size(double.infinity, 50), backgroundColor: _isAbove13 ? Colors.blue : Colors.grey,
                    ),
                    child: const Text(
                      'Submit',
  ...
  try {
    if (userId.isNotEmpty && _isAbove13) {
     ...
     // Navigator.pushReplacementNamed(context, '/home', arguments: userId);
      Navigator.push(
             context,
             MaterialPageRoute(builder: (context) => MyHomePage(name:_fullname,userId:userId)));
